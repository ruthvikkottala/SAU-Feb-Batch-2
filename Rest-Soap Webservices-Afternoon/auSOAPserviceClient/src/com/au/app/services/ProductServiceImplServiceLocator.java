...
public class ProductServiceImplServiceLocator extends org.apache.axis.client.Service implements com.au.app.services.ProductServiceImplService {
    ...
    private java.lang.String ProductServiceImpl_address = "http://localhost:8080/auSOAPservice/services/ProductServiceImpl";
    ...
    public com.au.app.services.ProductServiceImpl getProductServiceImpl() throws javax.xml.rpc.ServiceException {
    ...
    public com.au.app.services.ProductServiceImpl getProductServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.au.app.services.ProductServiceImplSoapBindingStub _stub = new com.au.app.services.ProductServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.au.app.services.ProductServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.au.app.services.ProductServiceImplSoapBindingStub _stub = new com.au.app.services.ProductServiceImplSoapBindingStub(new java.net.URL(ProductServiceImpl_address), this);
                _stub.setPortName(getProductServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://services.app.au.com", "ProductServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://services.app.au.com", "ProductServiceImpl"));
        }
